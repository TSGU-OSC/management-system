  ...
  <div>
      ...
      <el-col :span="24">
        ...
        <div class="grid-content  show"> -->
          <!-- <el-tooltip class="item" effect="dark" content="社团Gitee仓库" placement="bottom">
            <a href="https://gitee.com/TSGU-OSC">
              <img src="@/assets/new-icon/Gitee.svg" alt="Gitee" class="icon-svg">
            </a>
          </el-tooltip>
          <el-tooltip class="item" effect="dark" content="社团公众号" placement="bottom">
            <a href="https://mp.weixin.qq.com/s/-hXizFPHLnVHKgunq002Yg">
              <img src="@/assets/new-icon/Wechat.svg" alt="Wechat" class="icon-svg">
            </a>
          </el-tooltip>
          <el-tooltip class="item" effect="dark" content="社团OpenList存储系统" placement="bottom">
            <a href="http://172.19.15.18:5244/">
              <img src="@/assets/new-icon/OpenList.svg" alt="OpenList" class="icon-svg">
            </a>
          </el-tooltip>
          <el-tooltip class="item" effect="dark" content="社团GitHub" placement="bottom">
            <a href="https://github.com/TSGU-OSC">
              <img src="@/assets/new-icon/GitHub.svg" alt="GitHub" class="icon-svg">
            </a>
          </el-tooltip> -->
          <!-- <el-tooltip class="item" effect="dark" content="社团Gitlab" placement="bottom">
            <a href="http://82.157.80.221:2000"><i class="iconfont icon-Gitlab-fill"></i></a>
          </el-tooltip> -->
    ...
    <!-- <el-row>
      <el-col :span="24" style="text-align: center;">
        ...
        <p>如果你对开源技术充满热情，想要了解更多的开源项目和技术，欢迎加入我们的社团。请发送申请邮件至 jacklau1222@foxmail.com，我们将尽快与你联系。</p>
      </el-col>
    </el-row> -->
  </div>
</template>
